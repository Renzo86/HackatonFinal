...
module.exports = function(app) {
  ...
  app.get("/api/home/product", controller.findProduct); // Lista productos
  app.get("/api/home/product/:id", controller.findProductCat); // Lista productos por categoria
  app.get("/api/home/search/category/:data", controller.searchCategory); // Buscar categorias por descripcion
